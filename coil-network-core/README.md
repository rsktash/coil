...
```kotlin
implementation("uz.rsteam.coil-3:coil-network-okhttp:3.1.0") // Only available on Android/JVM.
implementation("uz.rsteam.coil-3:coil-network-ktor2:3.1.0")
implementation("uz.rsteam.coil-3:coil-network-ktor3:3.1.0")
```
